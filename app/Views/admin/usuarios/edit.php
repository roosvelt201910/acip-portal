...
$avatar = !empty($user['avatar']) 
    ? asset($user['avatar']) 
    : "https://ui-avatars.com/api/?name=" . urlencode($user['nombre']) . "&background=6366f1&color=ffffff&size=160";
?>
...
<div class="form-page">
    ...
    <div class="form-card">
        ...
        <form action="<?= url('admin/usuarios/update/' . $user['id']) ?>" method="POST" enctype="multipart/form-data">
            <div class="form-body">
                <!-- Avatar -->
                <div class="form-group">
                    <label class="form-label">Avatar</label>
                    <div class="avatar-upload">
                        <img id="avatarPreview" src="<?= $avatar ?>" alt="Avatar" class="avatar-preview">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" class="form-control" value="<?= htmlspecialchars($user['nombre']) ?>" required placeholder="Nombre del usuario">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Correo Electrónico <span class="required">*</span></label>
                        <input type="email" name="email" class="form-control" value="<?= htmlspecialchars($user['email']) ?>" required placeholder="correo@ejemplo.com">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Dejar en blanco para mantener" minlength="6">
                        <p class="form-help">Dejar en blanco si no deseas cambiar la contraseña</p>
                    </div>
                    <div class="form-group">
