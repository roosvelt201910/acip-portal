...
<div class="card-enterprise">
    <div class="card-header-enterprise">
        <h2><i class="fas fa-edit text-gray-400 mr-2"></i> Editar Noticia</h2>
    ...
    <form action="<?= url('admin/noticias/editar/' . $noticia['id']) ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row" style="display: flex; gap: 40px;">
                <div style="flex: 2;">
                    <div class="form-group-enterprise">
                        ...
                        <input type="text" name="titulo" class="input-enterprise" placeholder="Ingrese el título principal" value="<?= e($noticia['titulo']) ?>" required>
                    </div>
                    
                    <div class="form-group-enterprise">
                        <label class="label-enterprise">Resumen Corto <span class="text-red-500">*</span></label>
                        <textarea name="resumen" rows="3" class="input-enterprise" placeholder="Breve introducción para el listado..." required style="resize: vertical;"><?= e($noticia['resumen']) ?></textarea>
                    </div>

                    <div class="form-group-enterprise">
                        <label class="label-enterprise">Contenido Completo</label>
                        <textarea name="contenido" class="editor"><?= e($noticia['contenido']) ?></textarea>
                    </div>
                </div>
                     ...
                     <div style="background: #f8fafc; padding: 24px; border-radius: 12px; border: 1px solid #e2e8f0; position: sticky; top: 20px;">
                        ...
                        <div class="form-group-enterprise">
                            ...
                            <select name="categoria" class="input-enterprise">
                                <option value="institucional" <?= $noticia['categoria'] === 'institucional' ? 'selected' : '' ?>>Institucional</option>
                                <option value="academica" <?= $noticia['categoria'] === 'academica' ? 'selected' : '' ?>>Académica</option>
                        ...
                        <div class="form-group-enterprise">
                            ...
                            <input type="datetime-local" name="fecha_publicacion" class="input-enterprise" value="<?= date('Y-m-d\TH:i', strtotime($noticia['fecha_publicacion'])) ?>">
                        </div>
                        ...
                        <div class="form-group-enterprise">
                            ...
                            <select name="tipo_encabezado" id="tipoEncabezado" class="input-enterprise" onchange="toggleHeaderFields()">
                                <option value="imagen" <?= (!isset($noticia['tipo_encabezado']) || $noticia['tipo_encabezado'] === 'imagen') ? 'selected' : '' ?>>Imagen Hero</option>
                                <option value="video" <?= (isset($noticia['tipo_encabezado']) && $noticia['tipo_encabezado'] === 'video') ? 'selected' : '' ?>>Video Hero</option>
                            </select>
                        </div>
                        ...
                        <div id="videoField" class="form-group-enterprise" style="display: none;">
                            ...
                            <input type="text" name="video_encabezado" class="input-enterprise" placeholder="https://..." value="<?= e($noticia['video_encabezado'] ?? '') ?>" style="margin-bottom: 10px;">
                            ...
                            <div class="drop-zone" id="drop-video">
                                ...
                                <p>Arrastra video aquí o <span class="highlight-text">clic para actualizar</span></p>
...
// Add SweetAlert2 CDN if not in layout
$extraJS = '
