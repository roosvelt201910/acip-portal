...
<div class="card-enterprise">
    <div class="card-header-enterprise">
        <h2><i class="fas fa-plus-circle text-gray-400 mr-2"></i> Nueva Página</h2>
    ...
    <form action="<?= url('admin/paginas/crear') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="row" style="display: flex; gap: 40px;">
                <div style="flex: 2;">
                    <div class="form-group-enterprise">
                        ...
                        <input type="text" name="titulo" class="input-enterprise" placeholder="Ej: Política de Privacidad" required>
                    </div>
                    
                    <div class="form-group-enterprise">
                        <label class="label-enterprise">Slug (URL Amigable)</label>
                        <input type="text" name="slug" class="input-enterprise" placeholder="Dejar en blanco para generar automáticamente">
                ...
                <div style="flex: 1;">
                     <div style="background: #f8fafc; padding: 24px; border-radius: 12px; border: 1px solid #e2e8f0; position: sticky; top: 20px;">
                        ...
                        <div class="form-group-enterprise">
                            ...
                            <div class="radio-group">
                                <label class="radio-label">
                                    <input type="radio" name="media_type" value="image" checked onclick="toggleMedia('image')">
                                    <span>Imagen Hero</span>
                                </label>
                                <label class="radio-label">
                                    <input type="radio" name="media_type" value="video" onclick="toggleMedia('video')">
                                    <span>Video Hero</span>
                                </label>
                            </div>
                        </div>

                        <div id="media-video-group" class="form-group-enterprise" style="display: none;">
                        ...
                        <div id="media-image-group" class="form-group-enterprise">
                            ...
                            <div class="drop-zone" id="drop-hero">
                                ...
                                <div id="preview-hero" class="preview-grid" style="grid-template-columns: 1fr; margin-top: 15px;"></div>
                            </div>
                        </div>
                     </div>
                </div>
        ...
        <div style="padding: 24px 32px; background: #f8fafc; border-top: 1px solid #e2e8f0; text-align: right;">
            <button type="submit" class="btn-enterprise">
                <i class="fas fa-save mr-2"></i> Guardar Página
            </button>
        </div>
    </form>
</div>
